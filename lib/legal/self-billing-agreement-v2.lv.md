...
<!--
  ARHĪVA KOPIJA — šo failu neizmanto neviens kods.
  Lietotājam rādāmā versija tiek renderēta no app/noteikumi/self-billing/page.tsx,
  kas rekvizītus ņem no lib/operator-info.ts. Ja maini šo tekstu, sinhronizē abus.
-->
...
Versija 2.0 · Spēkā no 2026-09-01 · Aizstāj versiju 1.0

---

## 0. Kāpēc jauna versija

Platformas **tirgus.izipizi.lv** operators ir mainījies. Iepriekšējā versijā (1.0,
spēkā no 2026-04-29) Operators bija SIA "Svaigi". Sākot ar šīs versijas spēkā
stāšanās dienu, Platformu uztur un rēķinus Tirgotāja vārdā sastāda SIA "IziPizi".

Tā kā vienošanās saista Tirgotāju ar konkrētu juridisko personu, iepriekšējā
piekrišana nav automātiski pārnesama. Tirgotājam šī versija jāapstiprina no jauna.
Līdz apstiprināšanai Operators neizraksta jaunus rēķinus Tirgotāja vārdā un
neveic izmaksas par periodiem, kas sākas pēc spēkā stāšanās datuma.

Rēķini, kas izrakstīti līdz 2026-08-31 ar numura prefiksu `SV-`, paliek spēkā kā
SIA "Svaigi" grāmatvedības dokumenti un netiek pārnumurēti. Jaunie rēķini tiek
numurēti ar prefiksu `TIR-`.
...
**Operators:**
Sabiedrība ar ierobežotu atbildību "IziPizi"
Reģ. Nr.: 40203272626
PVN reģ. Nr.: LV40203272626
Juridiskā adrese: "Miltu cehs", Ogresgala pag., Ogres nov., LV-5041, Latvija
E-pasts: tirgus@izipizi.lv
Tālr.: +371 20031552
Banka: AS Citadele banka, IBAN: LV72PARX0023541960001, BIC: PARXLV22
(turpmāk — **Operators**)
...
- **1. periods:** mēneša 1.–15. datums (rēķins ne vēlāk kā mēneša 17. datumā)
...
- Rēķina numuru formātā **TIR-YYYY-NNNN** (sekvenciāls, nemainīgs)
- Rēķina sastādīšanas datumu
- Pārskata perioda sākuma un beigu datumu
- Operatora un Tirgotāja rekvizītus (1. sadaļa)
...
- Norāde: *"Šis rēķins sastādīts klienta self-billing kārtībā saskaņā ar PVN direktīvas 224. pantu un Tirgotāja-Operatora vienošanos no 2026-09-01."*
...
- Pakomātu tīklu un piegādes infrastruktūru
...
5.4. Operatora maiņa neietekmē jau apstiprinātās komisijas likmes.
...
11.2. Tirgotājs var atteikties no jaunās versijas, vai nu (a) izbeidzot vienošanos pēc 10.2. punkta, vai (b) skaidri paziņojot par neapstiprināšanu.

11.3. **Ja jaunā versija maina Operatora juridisko personu**, klusēšana netiek uzskatīta par akceptu — nepieciešama skaidra, atkārtota Tirgotāja piekrišana Platformā.

11.4. Pārējos gadījumos Tirgotāja klusums un Platformas turpmāka izmantošana pēc jaunās versijas spēkā stāšanās tiek uzskatīta par akceptu.
...
- Vienošanās versijas numurs (2.0)
...
*Vienošanās dokuments versijā 2.0, spēkā no 2026-09-01, Rīga.*
