...
const ZONE_3_CODES = [2008, 2010, 2011, 2012, 2015, 2016, 2105, 2136, 2140, 2141, 2150, 5001, 5015, 5016, 5041, 5052, 5060, 5070, 5071];
...
export const OUTSIDE_ZONES_CODES = [
  2113, 2124, 2125, 2133, 2135, 2142, 2144, 2145, 2151, 2152, 2154, 2160, 2161, 2162, 2170,
...
const LOCKER_COORDS: Record<string, { lat: number; lng: number; name: string; city: string; address: string; hours: string }> = {
  ...
  sigulda:    { lat: 57.1536, lng: 24.8577, name: "Sigulda",                city: "Sigulda",   address: "Rūdolfa Blaumaņa iela 2",       hours: "24/7" },
};
...
const POSTAL_DATA: Record<number, { lat: number; lng: number; place: string }> = {
  ...
  2136: { lat: 57.160, lng: 24.350, place: "Siguldas novads" },
  2140: { lat: 57.153, lng: 24.854, place: "Sigulda" },
  2141: { lat: 57.140, lng: 24.830, place: "Siguldas novads" },
  2150: { lat: 57.162, lng: 24.860, place: "Sigulda" },
