  ...
  return (
    <div className="flex min-h-[calc(100vh-64px)] items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <h1 className="text-center text-2xl font-extrabold text-gray-900">Izveido kontu</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <input type="password" value={password} onChange={(e) => setPassword(e.target.value)}
            className="input w-full" placeholder="Parole (min. 8 rakstzīmes)" required />
        ...
        <p className="mt-5 text-center text-sm text-gray-500">
          Jau ir konts?{" "}
          <Link href="/login" className="font-medium text-brand-600 hover:underline">Pieslēgties</Link>
        </p>
      </div>
    </div>
  );
